                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-around align-items-center">
                                <!-- View Icon -->
                                <a href="{{ route('admintask.show', $task->id) }}" class="btn btn-sm btn-info mx-1" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <!-- Edit Icon -->
                                <a href="{{ route('admin_task_edit.edit', $task->id) }}" class="btn btn-sm btn-warning mx-1" title="Edit">
